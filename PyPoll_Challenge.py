...
#Challenge: Track the county and its votes
county_options = []
county_votes = {}
total_county_percentage = 0


#Challenge: Track largest county turnout 
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        candidate_votes[candidate_name] += 1
         ...
         #Challenge: loop through file reader and find county names
    
         #Append for the county names 
...
#Print county results 
    ...
    #Find the county vote count and percentages
    for county in county_votes:
        #Find vote count and percentage 
        votes = county_votes[county]
        vote_percentage = float(votes) / float(total_votes) * 100 
        county_results = (
            f"{county}: {vote_percentage:.1f}% ({votes:,})\n")
     
     #Print each county voter count and their percentage to terminal   
